        ...
        <div className="navbar bg-base-100">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu dropdown-content mt-3 p-2 w-52">
                        {naivations}
                    </ul>
                </div>
            ...
            <div className="navbar-end">
                ...
                <button className="btn btn-outline rounded-none lg:mr-5 bg-violet-500 text-white bg-gradient-to-r from-violet-300 to-violet-700">Sign Up</button>
            </div>
        </div>
    );
};
