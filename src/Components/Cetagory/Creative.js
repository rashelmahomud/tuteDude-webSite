...
const Creative = () => {
    return (
        <div className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 lg:gap-10 gap-5 bg-violet-400 lg:px-48 p-10'>
            <div className='bg-gradient-to-r from-slate-300 to-violet-300 p-5 rounded-md'>
